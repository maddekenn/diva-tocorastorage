...
public class DivaFedoraRecordStorageTest {
	...
	// DataGroup readPerson = divaToCoraRecordStorage.read("person",
	...
	// DivaFedoraToCoraConverterSpy divaToCoraConverter =
	// (DivaFedoraToCoraConverterSpy) converterFactory.factoredConverters
	// .get(0);
	...
	//
	// divaToCoraRecordStorage.update("person", "diva-person:2233", record,
	// collectedTerms,
	...
	// assertEquals(httpHandlerFactory.urls.get(0),
	// baseURL +
	// "objects/diva-person:2233/datastreams/METADATA?format=?xml&controlGroup=M"
	...
	// assertEquals(httpHandler.requestProperties.get("Authorization"), "Basic " +
	// encoded);
	//
	...
	// DivaCoraToFedoraConverterSpy converterSpy = (DivaCoraToFedoraConverterSpy)
	...
	// DataGroup collectedTerms = createCollectTermsWithRecordLabel();
	//
	// divaToCoraRecordStorage.update("person", "diva-person:77", record,
	// collectedTerms, null,
	// null);
	// }
	//
	...
	// public void updateIfNotOkFromFedoraThrowExceptionOtherRecord() throws
	// Exception {
	// httpHandlerFactory.responseText = "Dummy response text";
	...
	// DataGroup collectedTerms = createCollectTermsWithRecordLabel();
	//
	// divaToCoraRecordStorage.update("person", "diva-person:23", record,
	// collectedTerms, null,
	// null);
	// }
	//
	...
	// public void readListThrowsNotImplementedExceptionForTypeNull() throws
	// Exception {
	...
	// + "The element type \"someTag\" must be terminated by the matching end-tag
	// \"</someTag>\".")
	// public void readListThrowsParseExceptionOnBrokenXML() throws Exception {
	// httpHandlerFactory.responseText = "<someTag></notSameTag>";
	// divaToCoraRecordStorage.readList("person",
	// DataGroup.withNameInData("filter"));
	// }
	//
	// @Test
	// public void readPersonListCallsFedoraAndReturnsConvertedResult() throws
	// Exception {
	// httpHandlerFactory.responseText = createXMLForPersonList();
	// Collection<DataGroup> readPersonList =
	// divaToCoraRecordStorage.readList("person",
	...
	// assertEquals(readPersonIterator.next(),
	// divaToCoraConverter.convertedDataGroup);
	// }
	//
