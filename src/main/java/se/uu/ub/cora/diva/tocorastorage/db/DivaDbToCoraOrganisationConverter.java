...
public class DivaDbToCoraOrganisationConverter implements DivaDbToCoraConverter {
    ...
    private void createAndAddName(Map<String, String> map, DataGroup organisation) {
        String divaOrganisationName = map.get("organisation_name");
        organisation.addChild(DataAtomic.withNameInDataAndValue("divaOrganisationName", divaOrganisationName));
    }
    ...
    private void createAndAddAlternativeName(Map<String, String> map, DataGroup organisation) {
        ...
        alternativeNameDataGroup.addChild(DataAtomic.withNameInDataAndValue("alternative_name", alternativeName));
    ...
    private void createAndAddEligibility(Map<String, String> map, DataGroup organisation) {
        ...
        organisation.addChild(DataAtomic.withNameInDataAndValue("divaOrganisationEligible", coraEligible));
    }
